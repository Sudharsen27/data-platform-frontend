...
export default function Drawer({
  ...
  return (
    <div className="fixed inset-0 z-[90] flex justify-end" role="dialog" aria-modal="true">
      ...
      />
      <div
        className={`relative flex h-full w-full flex-col border-l border-zinc-200 bg-white shadow-2xl ${width}`}
      >
        ...
        {footer ? (
          <footer className="shrink-0 border-t border-zinc-100 bg-zinc-50/80 px-5 py-4">{footer}</footer>
        ) : null}
      </div>
    </div>
  );
